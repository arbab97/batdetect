...
if __name__ == "__main__":
    ...
    # params
    detection_thresh = 0.99      # make this smaller if you want more calls
    ...
    # load data
    sample_size=5                             # Number of files to read
    ...
    op_file_name_total = os.path.join(op_ann_dir, 'results_15march.csv')
